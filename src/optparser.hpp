...
//
// Adapté pour la librairie standard par Francis Giraldeau
...
public:
  ...
  OptionsParser(int argc_, char *argv_[]) : argc(argc_), argv(argv_) {
  ...
  void AddOption(bool *var, const char *enable_short_name,
    ...
    options.push_back(Option(DISABLE, var, disable_short_name,
                             disable_long_name, description, required));
  }
  ...
  void AddOption(int *var, const char *short_name, const char *long_name,
    ...
    options.push_back(
        Option(INT, var, short_name, long_name, description, required));
  }
  ...
  void AddOption(real_t *var, const char *short_name, const char *long_name,
                 const char *description, bool required = false) {
    options.push_back(
        Option(DOUBLE, var, short_name, long_name, description, required));
  }
  ...
  void AddOption(const char **var, const char *short_name,
                 ...
                 bool required = false) {
    options.push_back(
        Option(STRING, var, short_name, long_name, description, required));
  }
  ...
  void AddOption(std::string *var, const char *short_name,
                 ...
                 bool required = false) {
    options.push_back(
        Option(STD_STRING, var, short_name, long_name, description, required));
  }
  ...
  void AddOption(std::vector<int> *var, const char *short_name,
                 ...
                 bool required = false) {
    options.push_back(
        Option(ARRAY, var, short_name, long_name, description, required));
  }
  ...
  void AddOption(std::vector<double> *var, const char *short_name,
                 ...
                 bool required = false) {
    options.push_back(
        Option(VECTOR, var, short_name, long_name, description, required));
  }
